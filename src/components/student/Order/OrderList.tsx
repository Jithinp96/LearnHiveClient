...
const OrderList = () => {
  ...
  const courseOrders: Order[] = [
    {
      orderId: '#95103',
      title: 'Advanced React Course',
      address: 'Web Development Fundamentals',
      date: '23/07/2022',
      price: 2334,
      status: 'Success',
    ...
    },
    {
      ...
      address: 'Programming Basics to Advanced',
      date: '02/11/2022',
      price: 5699,
      status: 'Canceled',
      image: '/api/placeholder/100/100'
  ...
  const slotOrders: Order[] = [
    {
      orderId: '#86543',
      title: '1-on-1 JavaScript Tutorial',
      address: 'With John Doe - Senior Developer',
      date: '12/12/2022',
      price: 7334,
      status: 'Success',
      image: '/api/placeholder/100/100'
    },
    {
      ...
      address: 'With Jane Smith - Mobile Expert',
      date: '10/12/2022',
      price: 10334,
      status: 'Success',
      image: '/api/placeholder/100/100'
