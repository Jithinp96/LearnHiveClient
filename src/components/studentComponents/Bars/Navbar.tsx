...
import { logoutStudentAPI } from '../../../api/studentAPI/studentAxios';
...
const Navbar: React.FC = () => {
  ...
  const { isAuthenticated, studentInfo } = useSelector((state: RootState) => state.student);
